...
#define nrn_init _nrn_init__snnap_ionic3
#define _nrn_initial _nrn_initial__snnap_ionic3
#define nrn_cur _nrn_cur__snnap_ionic3
#define _nrn_current _nrn_current__snnap_ionic3
#define nrn_jacob _nrn_jacob__snnap_ionic3
#define nrn_state _nrn_state__snnap_ionic3
#define _net_receive _net_receive__snnap_ionic3 
#define states states__snnap_ionic3 
...
#define Ainf Ainf_snnap_ionic3
#define tauA tauA_snnap_ionic3
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 snnap_ionic3 C:/S2N_CNS/snnap_ionic3.mod\n");
