...
#define nrn_init _nrn_init__snnap_cs
#define _nrn_initial _nrn_initial__snnap_cs
#define nrn_cur _nrn_cur__snnap_cs
#define _nrn_current _nrn_current__snnap_cs
#define nrn_jacob _nrn_jacob__snnap_cs
#define nrn_state _nrn_state__snnap_cs
#define _net_receive _net_receive__snnap_cs 
#define states states__snnap_cs 
...
extern Memb_func* memb_func;
 ...
 "SPDeriv", _hoc_SPDeriv,
 0, 0
};
#define BcsDeriv BcsDeriv_snnap_cs
#define SPDeriv SPDeriv_snnap_cs
 extern double BcsDeriv( _threadargsproto_ );
 extern double SPDeriv( _threadargsproto_ );
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 snnap_cs C:/S2N_CNS/snnap_cs.mod\n");
...
double SPDeriv ( _threadargsproto_ ) {
   double _lSPDeriv;
 if ( on  == 1.0 ) {
     _lSPDeriv = - SP / tauSP1 ;
     }
   else {
     _lSPDeriv = ( 1.0 - SP ) / tauSP2 ;
     }
   
return _lSPDeriv;
 }
 
static double _hoc_SPDeriv(void* _vptr) {
 double _r;
   double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt;
   _p = ((Point_process*)_vptr)->_prop->param;
  _ppvar = ((Point_process*)_vptr)->_prop->dparam;
  _thread = _extcall_thread;
  _nt = (_NrnThread*)((Point_process*)_vptr)->_vnt;
 _r =  SPDeriv ( _p, _ppvar, _thread, _nt );
 return(_r);
}
...
static void _initlists(){
 ...
 _slist1[2] = &(SP) - _p;  _dlist1[2] = &(DSP) - _p;
 _slist2[0] = &(Acs) - _p;
 _slist2[1] = &(Bcs) - _p;
 _slist2[2] = &(SP) - _p;
_first = 0;
